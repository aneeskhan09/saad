...
class Admin_model extends CI_Model
{
    ...
    ///////////////////////////////////////
    ///                                 ///
    ///      Orders Managment Area       ///
    ///                                 ///
    ///////////////////////////////////////
    public function getall_order($id)
    {
      $sql= "SELECT 
          *  
        FROM
          ...
          LEFT JOIN order_details 
            ON order_details.`customer_id` 
          ";
        return $this->db->query($sql)->result();
    }
    /******** UPDATE ORDER STATUS **********/
    public function update_order_status($data,$where)
    {
        return $this->db->where($where)->update('orders',$data);
    } 
}